...
//        dd($data);
        ...
        $csvDataFile = CsvData::where('csv_filename', $request->file('csv_file')->getClientOriginalName())->first();

        $csvData = array_slice(json_decode($csvDataFile->csv_data, true), 0, 10);
